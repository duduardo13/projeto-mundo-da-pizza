...
include_once 'conexao.php';
    ...
    if (!empty($_POST)) 
	{
		...
		$rs = $conexao->query("SELECT * FROM tb_usuario where nm_Usuario='$login'and senha_Usuario='$senha'");
		
		
		$rs -> execute();
		
        if (($login == "matheuschefe") && ($senha = "igorbroxa"))
        {
            $_SESSION['usuario'] = $login;
            header('Location:home.php');
        }
    ...
    <header> 
        ...
        <div class="menu-responsivo"> <!-- Menu hamburguer para o mobile -->
            ...
            <ul class="itens-menu"> <!-- Elementos clicáveis do menu (links de ancoragem) -->
                ...
                <li><a href="index.php#localizacao">Como Chegar</a></li>
                <li><a href="index.php#quemsomos">Quem Somos</a></li>
                <li><a href="index.php#promocoes">Promoções</a></li>
                <li><a href="index.php#faq">FAQ</a></li>
            </ul>
            
            <input type="checkbox" id="check"> <!-- Botão que abre o formulário de login -->
            <label for="check">
                <i class="entrar" id="btn">Entrar</i>
                <i class="fechar" id="cancel">Fechar</i>
            </label>
            <div id="login_form"> <!-- Formulário de Login Dropdown-->
                <br><h1>Entrar</h1><br>
                <ul id="login_list">
                <form actiion="#" method="POST">
                    <li><input class="txt" type="text" name="usuario_cliente" id="usuario_cliente" aria-describedby="usuario_cliente" placeholder="Nome de Usuário"></li>
                    <li><input class="txt" type="password" name="senha_cliente" id="senha_cliente" aria-describedby="senha_cliente" placeholder="Senha"></li>
                    <p><input type="checkbox">Salvar senha</p><br>
                    <li><input class="button" type="submit" value="Entrar"></li><br>
                    </form>
                </ul>
                
                <a href="cadastro/cadastroCliente.php">Ainda não tenho uma conta</a><br><br>
            </div>
         <!-- Fim do Menu -->
    </header>
